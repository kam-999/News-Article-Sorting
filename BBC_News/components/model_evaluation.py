from BBC_News.entity.config_entity import ModelEvaluationConfig
from BBC_News.entity.artifact_entity import ModelTrainerArtifact, DataIngestionArtifact, ModelEvaluationArtifact
...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[BBCEstimator]:
        """
        ...
        try:
            ...
            bbc_estimator = BBCEstimator(bucket_name=bucket_name,
                                               model_path=model_path)

            if bbc_estimator.is_model_present(model_path=model_path):
                return bbc_estimator
            return None
        except Exception as e:
