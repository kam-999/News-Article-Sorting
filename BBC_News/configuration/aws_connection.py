...
from BBC_News.constants import AWS_SECRET_ACCESS_KEY_ENV_KEY, AWS_ACCESS_KEY_ID_ENV_KEY,REGION_NAME
...
class S3Client:
    ...
    def __init__(self, region_name=REGION_NAME):
        ...
        if S3Client.s3_resource==None or S3Client.s3_client==None:
            ...
            logging.info("Successfully connected to AWS S3 using provided credentials.")
